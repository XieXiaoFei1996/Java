...
class HomeWorkDemo_1{
	public static void fun(int count,int scope) {
		...
		int number_1 = 0,number_2 = 0,number_3=0,number_4 = 0,number_5 = 0,number_6 = 0,number_7 = 0,number_8 = 0;
		...
		try {
			...
			for(int i =0;i<count1;i++) {
				...
				case 0:bufw.write("第"+(int)(i+1)+"题:"+new String(num[number_8++]+"+"+num[number_8++]+"="+total[i]));bufw.newLine();break;
				case 1:bufw.write("第"+(int)(i+1)+"题:"+new String(num[number_8++]+"-"+num[number_8++]+"="+total[i]));bufw.newLine();break;
				case 2:bufw.write("第"+(int)(i+1)+"题:"+new String(num[number_8++]+"*"+num[number_8++]+"="+total[i]));bufw.newLine();break;
				case 3:bufw.write("第"+(int)(i+1)+"题:"+new String(num[number_8++]+"/"+num[number_8++]+"="+total[i]));bufw.newLine();break;
				}
			}
		}catch(IOException e) {
			e.printStackTrace();
